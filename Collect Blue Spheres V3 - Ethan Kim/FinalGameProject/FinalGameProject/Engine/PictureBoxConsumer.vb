    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        Try
            ...
            If debugEnabled Then
                ...
                End If
                e.Graphics.DrawString("FPS: " + frameRate, SystemFonts.DefaultFont, Brushes.Black, 2, GameStatus.CAM_SIZE_Y * GameStatus.TILE_SIZE + 2)
                e.Graphics.DrawString(debugInfo, SystemFonts.DefaultFont, Brushes.Black, 80, GameStatus.CAM_SIZE_Y * GameStatus.TILE_SIZE + 2)

                e.Graphics.DrawString(manager.GetGame.ToString(), SystemFonts.DefaultFont, Brushes.Black, 2, GameStatus.CAM_SIZE_Y * GameStatus.TILE_SIZE + 16)
            End If
